...
export const cardsPrompt = (node: KnowledgeNode, language: SupportedLanguage = 'en') => ({
  system: [
    ...
    "- Order matters. Use exactly this arc: (1) text_explain intro lecture, (2) text_explain deeper explanation, (3) text_explain worked example, (4) analogy or visual bridge, (5) mcq exit question, (6) recap.",
    "- The lecture wording, the worked example explanation, the exit question, all options, and all feedback must be generated from the node data. Do not use generic template wording.",
    "- No check card before card 4. The learner needs at least 3 teaching cards first.",
    ...
    "- mcq phase: fifth card phase is exit.",
  ...
  user: JSON.stringify({
    ...
    allowedTypes: ["text_explain", "mcq", "recap", "analogy", "visual"],
    cardShapes: {
